...
public class Day5Star2
{
	public static void main(String[] args) 
	{
		...
		for (int i = 0; i < allCoords.size(); i++)
		{
			...
			else if (Math.abs(allCoords.get(i).getX1() - allCoords.get(i).getX2()) == Math.abs(allCoords.get(i).getY1() - allCoords.get(i).getY2())) 
			{
				if (allCoords.get(i).getX1() < allCoords.get(i).getX2() && allCoords.get(i).getY1() < allCoords.get(i).getY2())
				{
					for (int j = allCoords.get(i).getX1(); j <= allCoords.get(i).getX2(); j++)
					{
						int col = allCoords.get(i).getY1();
				...
				else if (allCoords.get(i).getX1() > allCoords.get(i).getX2() && allCoords.get(i).getY1() > allCoords.get(i).getY2())
				{
					for (int j = allCoords.get(i).getX2(); j <= allCoords.get(i).getX1(); j++)
					{
						int col = allCoords.get(i).getY2();
						int temp = board[j][col];
						board[j][col] = temp + 1;
						col++;
					}
